...
debris_depths = [0.25, 0.5, 1.] 	#pit depth in meters
...
dirname = "time-dependent-experiments/"
...
for debris_depth in debris_depths:
    ...
    indx_filename = "time-dependent-experiments_index.txt"

    simFileName = "time-dependent-experiments_" + str(debris_depth).replace('.', '') + "m_"
